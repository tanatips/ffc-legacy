...
public class ImageMap extends ImageView {
    ...
    private String mCurrentTouches;
    /*
                ...
                if (eventType == XmlPullParser.START_DOCUMENT) {
                    ...
                    if (loading) {
                        if (tag.equalsIgnoreCase("area")) {
                            ...
                            // System.out.println(shape+":"+coords+":"+id);
    ...
    private void initDrawingTools() {
        ...
        bubblePaint.setColor(0xFF33CC00);
        bubbleShadowPaint = new Paint();
        bubbleShadowPaint.setColor(0xFF336600);
    }
...
//        	index = index >> MotionEvent.ACTION_POINTER_ID_SHIFT;
    ...
    abstract class Area {
        ...
        public void onDraw(Canvas canvas) {
            if (_decoration != null) {
                ...
                canvas.drawBitmap(_decoration, x, y, p);
    ...
    public String getCurrentTouches() {
        return mCurrentTouches;
    }

    public void setCurrentTourches(int areaId) {
        Area a = mIdToArea.get(areaId);
        if (a != null) {
            this.mCurrentTouches = a.getName();
