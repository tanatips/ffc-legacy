 ...
 */
public class NationListDialog extends FFCSearchListDialog.BaseAdapter {
    ...
    public Loader<Cursor> onLoadCursor(String filter) {
        Uri uri = Nation.CONTENT_URI;
        String selection = null;
        if (!TextUtils.isEmpty(filter)) {
            selection = Nation.NAME + " LIKE '%" + filter + "%' or " +
                    Nation._ID + " LIKE '" + filter + "%'";
        }
