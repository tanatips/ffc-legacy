 ...
 * @since 1.0
 */
public class DiagDisableListDialog extends FFCSearchListDialog.BaseAdapter {
    ...
    public Loader<Cursor> onLoadCursor(String filter) {
        ...
        String selection = "diseasenamethai LIKE '%�ԡ��%'";
        if (!TextUtils.isEmpty(filter)) {
            selection = "diseasenamethai LIKE '%�ԡ��%' AND (" + Diagnosis.CODE + " LIKE '%" + filter + "%' or "
