...
public class PhotoPerson {
    ...
    public static final String TAG = "PhotoPerson";
    ...
    public PhotoPerson(Activity activity) {
        this(activity, "/sdcard/", "PhotoPerson.jpg");
    }

    // Base Constructor
    public PhotoPerson(Activity activity, String path, String name) {
        mActivity = activity;
        setOutput(path, name);
    ...
    public PhotoPerson(Activity activity, OnCropFinishListener listener) {
        this(activity);
        mOnFinishListener = listener;
    }
    ...
    public boolean doCropImage(Uri uri) {
        try {
            ...
            Intent intent = new Intent(PhotoPerson.ACTION_CROP_IMAGE);
